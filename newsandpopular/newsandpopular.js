...
window.onload = () => {
    setNavbarProfiles();
    showContent("tv/popular?language=en-US&page=1","cardContainer");
    showContent("tv/top_rated?language=en-US&page=1","showscontainer");
    showContent("tv/on_the_air?language=en-US&page=1","moviesContainer");
    showContent("tv/airing_today?language=en-US&page=1","nextWeekContainer");
    showContent("tv/airing_today?language=en-US&page=1","worthWaitContainer");
    showContent("tv/on_the_air?language=en-US&page=1","comingThisWeekContainer");
